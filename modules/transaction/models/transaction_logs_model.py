...
class TransactionLog(ModelBase):
    ...
    transactions_log_id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    transactions_log_transactions_datetime = Column(DateTime, unique=True, nullable=False)
